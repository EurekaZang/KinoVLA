#!/usr/bin/env python3
"""Run every incomplete scene through the F23-corrected v6 pipeline."""
...
PIPELINE = ROOT / "scripts/run_kinofail_reconfirmation_scene_pipeline_v6.py"
AUDIT_PATH = (
    ROOT
    / "outputs/kinofail_reconfirmation_v2/orchestration/"
    "all_scenes_pipeline_f23.jsonl"
)
