#!/usr/bin/env python3
"""Run each incomplete scene with the F19 storage-aware v4 pipeline."""
...
PIPELINE = ROOT / "scripts/run_kinofail_reconfirmation_scene_pipeline_v4.py"
AUDIT_PATH = (
    ROOT
    / "outputs/kinofail_reconfirmation_v2/orchestration/"
    "all_scenes_pipeline_f19.jsonl"
)
...
def main() -> int:
    ...
    scenes = sorted(inventory - excluded)
