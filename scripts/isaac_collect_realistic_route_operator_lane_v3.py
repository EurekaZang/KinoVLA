#!/usr/bin/env python3
"""Collect one native cross-domain realistic O1/O2/O3 operator lane.

This version statically binds the shared route protocol and supports both the
...
def main() -> int:
    ...
    try:
        ...
        manifest = {
            "schema_version": (
                f"kinofail.realistic-route-{args.operator}-fresh-app-lane.v3-protocol-candidate"
            ),
            "scene_route_binding": {
            ...
            "collector_lifecycle": "native_v3_protocol_candidate",
            "lane": args.lane,
