#!/usr/bin/env python3
"""Collect one lane-aware route-gated cross-domain realistic O1/O2/O3 lane.

Version 5 retains full-lane tracking and makes region coverage lane-aware: nominal lanes require sustained coverage, while anomaly lanes may terminate early only after measured load-bearing contact.
...
def main() -> int:
    ...
    try:
        ...
        manifest = {
            "schema_version": (
                f"kinofail.realistic-route-{args.operator}-fresh-app-lane.v5-protocol-candidate"
            ),
            "scene_route_binding": {
            ...
            "collector_lifecycle": "native_v5_lane_aware_tracking_gated_protocol_candidate",
            "lane": args.lane,
