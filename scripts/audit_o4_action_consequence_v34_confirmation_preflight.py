#!/usr/bin/env python3
"""Fail-closed preflight for prospective v34 O4 held-out confirmation."""
...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        == "kinofail.o4-action-consequence-v34-heldout-confirmation-freeze.v1",
        "frozen_before_first_execution": config.get("freeze_status")
        == "frozen_before_first_v34_heldout_o4_execution",
        "strict_evidence_quarantine": evidence.get("heldout_confirmation") is True
        ...
        "cohort_size_and_family_coverage": len(cases) == cohort.get("admitted")
        and len(cases) >= 6
        ...
        "v32_runtime_exactly_inherited": runtime_source_path.is_file()
        ...
        "state_aware_visual_contract_exactly_inherited": config.get(
            "visual_qa_contract"
        )
    ...
    result = {
        "schema_version": "kinofail.o4-action-consequence-v34-heldout-preflight.v1",
