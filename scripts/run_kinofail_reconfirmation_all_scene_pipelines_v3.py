#!/usr/bin/env python3
"""Run every incomplete frozen scene with the F17 work-conserving pipeline."""
...
PIPELINE = ROOT / "scripts/run_kinofail_reconfirmation_scene_pipeline_v3.py"
AUDIT_PATH = (
    ROOT
    / "outputs/kinofail_reconfirmation_v2/orchestration/"
    "all_scenes_pipeline_f17.jsonl"
)
